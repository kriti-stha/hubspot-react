...
export const Component = ({ fieldValues, hublParameters = {} }) => {
    ...
    const { title } = hublParameters || 'Default title';
    ...
    return (
        ...
        <div className={styles.team}>
            ...
            <div key={index} className={styles.member}>
                <img src={teamMember.team_member_photo.src} alt={teamMember.team_member_photo.alt} height={teamMember.team_member_photo.height} width={teamMember.team_member_photo.width} />
